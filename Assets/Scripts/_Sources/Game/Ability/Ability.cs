...
namespace End.Game
{
	public abstract class Ability
	{
		...
		/// </returns>
		public abstract GameEntity GetTargetEntity(GameEntity caster, GameEntity targetTile);
		...
		public abstract void OnTargetSelected(GameEntity caster, GameEntity target);
	}
}
