...
public class WeatherResloveDisplayer : MonoBehaviour {
	...
	public void AddOnResolveAction(UnityAction action)
	{
		var exitState = GetWeatherExitState();
		exitState.OnCompletedAction += action;
	}

	private WeatherResolveExit GetWeatherExitState()
	{
		return Animator.GetBehaviour<WeatherResolveExit>();
	}
}
