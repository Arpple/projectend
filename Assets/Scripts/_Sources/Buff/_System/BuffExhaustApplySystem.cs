...
public class BuffExhaustApplySystem : BuffReactiveSystem
{
	private int _damageReduceAmount;

	public BuffExhaustApplySystem(Contexts contexts, BuffSetting setting) : base(contexts)
	{
	...
	{
		return context.CreateCollector(BuffMatcher.BuffExhaust, GroupEvent.Added);
	}
